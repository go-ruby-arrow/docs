...
Contributions are welcome. `go-ruby-arrow/arrow` is built to a small set of
...
The library is in [`github.com/go-ruby-arrow/arrow`](https://github.com/go-ruby-arrow/arrow).
This documentation site is in [`github.com/go-ruby-arrow/docs`](https://github.com/go-ruby-arrow/docs).

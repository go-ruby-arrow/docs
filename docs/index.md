# go-ruby-arrow documentation

**Pure-Go (CGO=0), MRI-faithful red-arrow: Apache Arrow arrays/schema/table/record-batch + IPC over apache/arrow-go**

`go-ruby-arrow/arrow` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `arrow`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `arrow`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`arrow`](https://github.com/go-ruby-arrow/arrow) | the library — Ruby's `arrow` in pure Go |
| [`docs`](https://github.com/go-ruby-arrow/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-arrow.github.io`](https://github.com/go-ruby-arrow/go-ruby-arrow.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-arrow/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-arrow/arrow](https://github.com/go-ruby-arrow/arrow).

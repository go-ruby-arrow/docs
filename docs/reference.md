...
```go
import "github.com/go-ruby-arrow/arrow"
```
...
- **[pkg.go.dev/github.com/go-ruby-arrow/arrow](https://pkg.go.dev/github.com/go-ruby-arrow/arrow)**

The module's [README](https://github.com/go-ruby-arrow/arrow#readme) carries worked

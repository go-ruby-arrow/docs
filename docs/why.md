...
`go-ruby-arrow/arrow` reimplements Ruby's `arrow` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-arrow/arrow` directly, with no Ruby runtime;
